...
\lhead{\includegraphics[scale=0.011]{generate_latex/assets/UnB.png} Universidade de Brasilia}
\rhead{Aguardando o PR adicionando HLD na QueryTree}

% CONFIG: Title and team name
\title{Competitive Programming Notebook} % \emoji{balloon} }         
\author{Aguardando o PR adicionando HLD na QueryTree}
\date{}
