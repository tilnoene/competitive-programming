// Código do Bruno Maletta!!!!!!
// pra problemas mais simples, usar a treap do cp!
// essa aqui é mais poderosa, mas por isso é um pouco mais lenta
...
// Nesse problema vc tem que printar a soma de l...r
// e tmb dar um reverse no range l...r
void solve() {  
    ...
    for(int i = 0; i < n; i++) {
		ll re; cin >> re;
        // coloca esse vertice no final do array (que tá armazenado na treap)
		root.push_back(re);
	}
